...
def main() -> int:
    ...
    cache.insert(3, refetch_cost_pj=10.0)
    ...
    ecache.insert(2, refetch_cost_pj=10.0, global_frequency=1)
    check("expert 3 misses", not ecache.hit(3))
    evicted = ecache.insert(3, refetch_cost_pj=10.0, global_frequency=1)
    ...
    trace_hit = _make_trace([(0, 0, 1), (1, 0, 1)])
